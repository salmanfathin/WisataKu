...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null){
            ...
            updateTitle.setText(bundle.getString("Nama"));
            updateDesc.setText(bundle.getString("Deskripsi"));
            updateLang.setText(bundle.getString("Language"));
            key = bundle.getString("Key");
            oldImageURL = bundle.getString("Gambar");
        }
        databaseReference = FirebaseDatabase.getInstance().getReference("Wisata Kuningan").child(key);
    ...
    public void saveData(){
        storageReference = FirebaseStorage.getInstance().getReference().child("Wisata Kuningan").child(uri.getLastPathSegment());
